...
## Developer Resources
**All contributions made to VIA code repository will be licensed under the [BSD-2 clause license](https://gitlab.com/vgg/via/blob/master/LICENSE).**
...
file.  The [Quality Assessment](via-2.x.y/QualityAssessment.md)
